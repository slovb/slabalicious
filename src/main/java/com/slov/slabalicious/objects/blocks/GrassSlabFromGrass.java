...
public class GrassSlabFromGrass extends GrassBlock implements IWaterLoggable {
	...
	public GrassSlabFromGrass(Properties properties) {
		super(properties);
	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		...
		if (blockstate.getBlock() == this) {
			...
			BlockState blockstate1 = this.getDefaultState()
					...
					.with(SNOWY, Boolean.valueOf(block == Blocks.SNOW_BLOCK || block == Blocks.SNOW));
